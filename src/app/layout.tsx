...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "instalación de paneles solares","solar energy","green energy solutions",
    "solar panels installation","clean energy",
  ],

  alternates: {
    canonical: "/", // → https://www.egskollenergy.com/
    languages: {
      es: "/", // ES → raíz
      en: "/en", // EN → https://www.egskollenergy.com/en
      "x-default": "/", // fallback global
    },
  },
