  ...
  es: {
    ...
    projects: [
      ...
      },
      {
        ...
        folder: 'LaHabana',
        baseName: 'LaHabana',
        name: 'Sistema fotovoltaico residencial en La Habana',
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        folder: 'LaHabana',
        baseName: 'LaHabana',
        name: 'Residential PV System in Havana',
          ...
          {t.projects.map((proj) => (
            ...
            >
              ...
              <span className="mt-4 inline-flex items-center text-sm font-semibold text-emerald-600 group-hover:text-emerald-700">
                {currentLang === 'es' ? 'Ver fotos del proyecto' : 'View project photos'}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
          <div className="bg-white rounded-2xl max-w-5xl w-full p-4 sm:p-6 md:p-8 shadow-xl relative">
            ...
            <button
              ...
              aria-label={currentLang === 'es' ? 'Cerrar galería' : 'Close gallery'}
            >
              ✕
            </button>
            ...
            <div className="relative w-full h-64 sm:h-80 md:h-[26rem] mb-4 md:mb-6 overflow-hidden rounded-2xl">
              ...
              <button
                ...
                aria-label={currentLang === 'es' ? 'Foto anterior' : 'Previous photo'}
              >
                ‹
              </button>
              <button
                ...
                aria-label={currentLang === 'es' ? 'Foto siguiente' : 'Next photo'}
              >
                ›
              </button>
